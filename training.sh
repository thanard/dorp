...
do
    CUDA_VISIBLE_DEVICES=$i python main.py --n_agents $((i+3)) --seed 80 \
    --savepath results/grid --step_size 1 --n_traj 60 --len_traj 1000 --switching_factor_freq 50 &
done

for i in 0 1 2 3
do
    CUDA_VISIBLE_DEVICES=$i python main.py --n_agents $((i+3)) --seed 80 \
    --savepath results/grid --random_step_size --step_size 5 --n_traj 60 --len_traj 1000 --switching_factor_freq 50 &
done

for i in 0 1 2 3
do
    CUDA_VISIBLE_DEVICES=$i python main.py --n_agents $((i+3)) --seed 80 \
    --savepath results/grid --random_step_size --step_size 20 --n_traj 60 --len_traj 1000 --switching_factor_freq 50 &
done

for i in 0 1 2 3
do
    CUDA_VISIBLE_DEVICES=$i python main.py --n_agents $((i+3)) --seed 80 \
    --savepath results/grid --random_step_size --step_size 5 --n_traj 60 --len_traj 1000 --switching_factor_freq 20 &
done